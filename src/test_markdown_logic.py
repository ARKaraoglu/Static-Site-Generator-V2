...
class TestMergeImageTokens(unittest.TestCase):
    def test_merge_image_tokens(self):
        ...
        self.assertEqual(new_tokens, [("TEXT", "This is a line with"),("SPACE", " ") ,TextNode("image alt", TextType.IMAGE, "#"),("SPACE", " ") , ("TEXT", "in it"), ("EX_MARK", "!")])
    
    def test_merge_image_tokens2(self):
        line = "This is a line with ![ image alt ](#) in it!"
        tokens = tokenizer(line)
        new_tokens = merge_image_tokens(tokens)
        self.assertEqual(new_tokens, [("TEXT", "This is a line with"),("SPACE", " ") ,TextNode(" image alt ", TextType.IMAGE, "#"),("SPACE", " ") , ("TEXT", "in it"), ("EX_MARK", "!")])
    
    def test_merge_image_tokens3(self):
        line = "This is a line with !![image alt](#) in it!"
        tokens = tokenizer(line)
        new_tokens = merge_image_tokens(tokens)
        self.assertEqual(new_tokens, [("TEXT", "This is a line with"),("SPACE", " ") ,("EX_MARK", "!") ,TextNode("image alt", TextType.IMAGE, "#"),("SPACE", " ") , ("TEXT", "in it"), ("EX_MARK", "!")])
    
    def test_merge_image_tokens_inline_markdown_in_src_and_alt(self):
        line = "This is a line with ![[***__`image alt`__***]]((**#*)) in it!"
        tokens = tokenizer(line)
        new_tokens = merge_image_tokens(tokens)
        self.assertEqual(new_tokens, [("TEXT", "This is a line with"),("SPACE", " ") ,TextNode("[***__`image alt`__***]", TextType.IMAGE, "(**#*)"),("SPACE", " ") , ("TEXT", "in it"), ("EX_MARK", "!")])
    ...
    def test_merge_image_tokens_multi_image(self):
        ...
        tokens = tokenizer(line)
        new_tokens = merge_image_tokens(tokens)
        self.assertEqual(new_tokens, [("TEXT", "This is a line with"),("SPACE", " ") ,TextNode("image alt", TextType.IMAGE, "#"),("SPACE", " ") , ("TEXT", "more than 1 image"),("SPACE", " ") , TextNode("second image alt", TextType.IMAGE, "image source"), ("TEXT", "in it"), ("EX_MARK", "!")])

    def test_merge_image_tokens_multi_image_single_link(self):
        line = "This is a line with ![image alt](#) [more than](1 image) ![second image alt](image source)in it!"
        tokens = tokenizer(line)
        new_tokens = merge_image_tokens(tokens)
        self.assertEqual(new_tokens, [("TEXT", "This is a line with"),("SPACE", " ") ,TextNode("image alt", TextType.IMAGE, "#"),("SPACE", " "),("OP_BR", 1),("TEXT", "more than"),("CL_BR", 1),("OP_PA", 1),("TEXT", "1 image"), ("CL_PA", 1), ("SPACE", " "), TextNode("second image alt", TextType.IMAGE, "image source"), ("TEXT", "in it"), ("EX_MARK", "!")])


    def test_merge_image_tokens_double_closing_par(self):
        line = "This is a line with ![image alt](#))"
        tokens = tokenizer(line)
        new_tokens = merge_image_tokens(tokens)
        self.assertEqual(new_tokens, [("TEXT", "This is a line with"),("SPACE", " ") ,TextNode("image alt", TextType.IMAGE, "#)")])
    
    def test_merge_image_tokens_wrong_image_format(self):
        line = "This is a line with ![image alt] (#) in it!"
        tokens = tokenizer(line)
        new_tokens = merge_image_tokens(tokens)
        self.assertEqual(new_tokens, [("TEXT", "This is a line with"),("SPACE", " ") ,("EX_MARK", "!"),("OP_BR", 1), ("TEXT", "image alt"),("CL_BR", 1),("SPACE", " "),("OP_PA", 1), ("TEXT", "#"), ("CL_PA", 1),("SPACE", " ") , ("TEXT", "in it"), ("EX_MARK", "!")])

    def test_merge_image_tokens_wrong_image_format2(self):
        line = "This is a line with ![image alt"
        tokens = tokenizer(line)
        new_tokens = merge_image_tokens(tokens)
        self.assertEqual(new_tokens, [("TEXT", "This is a line with"),("SPACE", " ") ,("EX_MARK", "!"),("OP_BR", 1), ("TEXT", "image alt")])

    def test_merge_image_tokens_wrong_image_format3(self):
        line = "This is a line with ![image alt]]"
        tokens = tokenizer(line)
        new_tokens = merge_image_tokens(tokens)
        self.assertEqual(new_tokens, [("TEXT", "This is a line with"),("SPACE", " ") ,("EX_MARK", "!"),("OP_BR", 1), ("TEXT", "image alt"),("CL_BR", 2)])

    def test_merge_image_tokens_wrong_format(self):
        line = "This is a line with ![image alt] a wrong image in it!"
        tokens = tokenizer(line)
        new_tokens = merge_image_tokens(tokens)
        self.assertEqual(new_tokens, [("TEXT", "This is a line with"),("SPACE", " ") , ("EX_MARK", "!"), ("OP_BR", 1), ("TEXT", "image alt"), ("CL_BR", 1),("SPACE", " ") ,("TEXT", "a wrong image in it"), ("EX_MARK", "!")])

    def test_merge_image_tokens_wrong_format2(self):
        line = "This is a line with ![image alt] a wrong ![alt](source)image in it!"
        tokens = tokenizer(line)
        new_tokens = merge_image_tokens(tokens)
        self.assertEqual(new_tokens, [("TEXT", "This is a line with"),("SPACE", " ") , ("EX_MARK", "!"), ("OP_BR", 1), ("TEXT", "image alt"), ("CL_BR", 1),("SPACE", " ") , ("TEXT", "a wrong"),("SPACE", " ") , (TextNode("alt", TextType.IMAGE, "source")), ("TEXT", "image in it"), ("EX_MARK", "!")])

    def test_merge_image_tokens_wrong_format3(self):
        line = "This is a line with ![image alt]* a wrong ![alt](source)image in it!"
        tokens = tokenizer(line)
        new_tokens = merge_image_tokens(tokens)
        self.assertEqual(new_tokens, [("TEXT", "This is a line with"), ("SPACE", " ") ,("EX_MARK", "!"), ("OP_BR", 1), ("TEXT", "image alt"), ("CL_BR", 1), ("STAR", 1),("SPACE", " ") , ("TEXT", "a wrong"),("SPACE", " ") , (TextNode("alt", TextType.IMAGE, "source")), ("TEXT", "image in it"), ("EX_MARK", "!")])
...
class TestMergeLinkTokens(unittest.TestCase):
    def test_merge_link_tokens(self):
        ...
        self.assertEqual(new_tokens, [("TEXT", "This line has 1 link"),("SPACE", " ") ,(TextNode("link alt", TextType.LINK, "link url")),("SPACE", " ") , ("TEXT", "in it"), ("EX_MARK", "!")])
    ...
    def test_merge_link_tokens2(self):
        ...
        self.assertEqual(new_tokens, [(TextNode("[link text]", TextType.LINK, "()")),("TEXT", "This line has more"),("SPACE", " ") ,(TextNode("text", TextType.LINK, "link")), ("SPACE", " ") ,("TEXT", "than 1 link in it"),("EX_MARK", "!"), ("SPACE", " "),(TextNode("**link text**", TextType.LINK, "https://url"))])
    ...
    def test_merge_link_tokens_with_image_node(self):
        ...
        self.assertEqual(new_tokens2, [("OP_BR", 1), ("TEXT", "text"), ("CL_BR", 1), ("SPACE", " "), ("OP_PA", 1), ("TEXT", "url"), ("CL_PA", 1), ("TEXT", "This line has"), ("SPACE", " ") , ("OP_BR", 1), ("STAR", 4), ("CL_BR", 1), (TextNode("image alt", TextType.IMAGE, "**image source**")),("SPACE", " ") , ("TEXT", "image"),("SPACE", " ") , (TextNode("link text", TextType.LINK, "link url")),("SPACE", " ") , ("TEXT", "node in it"), ("EX_MARK", "!")])
    ...
    def test_merge_link_tokens_inline_image_node(self):
        ...
        new_tokens = merge_image_tokens(tokens)
        new_tokens2 = merge_link_tokens(new_tokens)
        self.assertEqual(new_tokens2, [("TEXT", "There is a link with image") ,("SPACE", " ") ,(ParentNode("a", [TextNode("image alt", TextType.IMAGE, "image source")], "link url")),("SPACE", " ") ,("TEXT", "as link text in this line")])
    ...
    def test_merge_link_tokens_inline_image_node2(self):
        ...
        new_tokens = merge_image_tokens(tokens)
        new_tokens2 = merge_link_tokens(new_tokens)
        self.assertEqual(new_tokens2,[("TEXT", "There is a link with image"),("SPACE", " ") ,ParentNode("a", [TextNode("**", TextType.TEXT),TextNode("image alt", TextType.IMAGE, "image source"), TextNode("**", TextType.TEXT) ], "link url"),("SPACE", " ") ,("TEXT", "as link text in this line")])
...
class TestMergeCodeTokens(unittest.TestCase):
    def test_merge_code_tokens_valid1(self):
        ...
        self.assertEqual(new_tokens, [("TEXT", "This is a line with"), ("SPACE", " "), (TextNode("code", TextType.CODE)),("SPACE", " ") ,("TEXT", "in it"), ("EX_MARK", "!")])

    def test_merge_code_tokens_valid2(self):
        line = "This is a line with `**code**` in it!`This is the second Code`"
        tokens = tokenizer(line)
        new_tokens = merge_code_tokens(tokens)
        self.assertEqual(new_tokens, [("TEXT", "This is a line with"),("SPACE", " ") , (TextNode("**code**", TextType.CODE)), ("SPACE", " ") ,("TEXT", "in it"), ("EX_MARK", "!"), (TextNode("This is the second Code", TextType.CODE))])

    def test_merge_code_tokens_valid3(self):
        line = "This is a line with ``code text`` in it!"
        tokens = tokenizer(line)
        new_tokens = merge_code_tokens(tokens)
        self.assertEqual(new_tokens, [("TEXT", "This is a line with"),("SPACE", " ") , (TextNode("code text", TextType.CODE)),("SPACE", " ") ,("TEXT", "in it"), ("EX_MARK", "!")])
    ...
    def test_merge_code_tokens_valid7(self):
        ...
        tokens = tokenizer(line)
        new_tokens = merge_code_tokens(tokens)
        self.assertEqual(new_tokens, [("TEXT", "This is a line with"),("SPACE", " ") , (TextNode("code `` foo `` text", TextType.CODE)),("SPACE", " ") , ("TEXT", "in it"), ("EX_MARK", "!")])
    ...
    def test_merge_code_tokens_valid16(self):
        ...
        tokens = tokenizer(line)
        new_tokens = merge_code_tokens(tokens)
        self.assertEqual(new_tokens, [("TEXT", "This is a line with"),("SPACE", " ") ,(TextNode(" ``` ", TextType.CODE)), ("SPACE", " ") ,("TEXT", "in it"),("EX_MARK", "!")])
